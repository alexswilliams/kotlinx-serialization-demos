...
fun main() {
    ...
    val firstInvocationSingleMillis = measureTimeMillis { jsonMapper.stringify(Cat.serializer(), singleCat) }
    ...
    repeat(1000) { jsonMapper.stringify(Cat.serializer(), singleCat) }

    val iterations =
        (1..100_000).map { measureNanoTime { jsonMapper.stringify(Cat.serializer(), singleCat) } }
